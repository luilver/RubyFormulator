...
single_choice = PollType.create(text: 'Single Choice')
multiple_choice = PollType.create(text: 'Multiple Choice')
_quiz_mode = PollType.create(text: 'Quiz mode')
_true_false = PollType.create(text: 'True/False')
_open_ended = PollType.create(text: 'Open-Ended')
_rating_scale = PollType.create(text: 'Rating Scale')
_ranking = PollType.create(text: 'Ranking')
_yes_no = PollType.create(text: 'Yes/No')
